...
public class SensorsFogConcnActivity extends BaseActivity {
    ...
    @OnClick({ R.id.get_smoke_concentration_bt, R.id.set_smoke_concentration_bt})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.get_smoke_concentration_bt:
                SendMsg(new Protocol(0,2,0,0).sendProtocol());
                break;
            case R.id.set_smoke_concentration_bt:
                SendMsg(new Protocol(0,2,0,1,mSeekBar.getProgress()).sendProtocol());
                break;
        }
    }
    ...
    public void initView() {
        mTextView = (TextView)findViewById(R.id.front_distance_tv);
        mSeekBar = (SeekBar)findViewById(R.id.set_smoke_concentration_sb);
    }
